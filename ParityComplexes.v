...
(* ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ *)
 ...
 Qed.
  ...
  Proof with intuition.
    ...
    (* I don't know why I bothered with this *)
    fold (is_a_cell'
        ((sup
    ...
    (* M is an (n-1)-cell, with disjoint condition (Minus S' and A are disjoint)*)
    (* if you think about it, this is really superfluous, we already know both of these things *)
    assert (is_a_cell
        (sup (sup (sup tM n ∪ ((sub tM (S n) ∪ Minus T) ∩ √Plus T)) n
            ∪ ((sub (sup tM n ∪ ((sub tM (S n) ∪ Minus T) ∩ √Plus T)) (S n)
                ∪ Minus (plus x)) ∩ √Plus (plus x))) n ∪ ((sub (sup (sup tM n ∪ ((sub tM (S n) ∪ Minus T) ∩ √Plus T)) n
    ...
    assert (Disjoint (Minus S') (Plus (minus x))) as HardDisj.
      ...
      unfold A.
      apply (Same_set_is_a_cell _ _ H1).
      unfold tM.
      repeat (rewrite sup_Union || rewrite sub_Union).
      repeat (rewrite sup_idemp || rewrite sub_idemp).
      repeat (rewrite (sub_sup_Empty_set n (S n)) || rewrite (sup_sub_Empty_set (S n) n))...
      repeat (rewrite Empty_set_ident_right || rewrite Empty_set_ident_left).
      rewrite <- Bdef.
      fold A.
      rewrite Bdim.
      rewrite <- Adef.
    ...
    assert (Disjoint (Minus (minus x)) (Plus T)) as HardDisj2.
      ...
      repeat (rewrite Empty_set_ident_right || rewrite Empty_set_ident_left).
      rewrite <- Bdef...
      rewrite Bdim. rewrite <- Adef. rewrite <- Bdim. rewrite sup_sub_Empty_set...
      rewrite Empty_set_ident_right...      
      unfold tP, tM.
      repeat (rewrite sup_Union || rewrite sub_Union).
      repeat (rewrite sup_idemp || rewrite sub_idemp).
      ...
      rewrite <- Adef.
      rewrite sup_sup_min...
      rewrite <- Bdim. rewrite sup_sub_Empty_set...
      rewrite Empty_set_ident_right...      
      apply (Same_set_is_a_cell _ _ H).
      unfold tM.
      repeat (rewrite sup_Union || rewrite sub_Union).
      repeat (rewrite sup_idemp || rewrite sub_idemp).
      repeat (rewrite (sub_sup_Empty_set n (S n)) || rewrite (sup_sub_Empty_set (S n) n))...
  ...
  Lemma Lemma_3_2_b_work :
    Prop_3_3_st -> forall n m, (Lemma_3_2_b_st n m /\ Lemma_3_2_b_dual_st n m).
  Proof.
    intros Prop_3_3 n.
    induction n.
    + intros m; destruct m.
  ...
  Lemma Lemma_3_2_b_dual :
    Prop_3_3_st -> forall n m, (Lemma_3_2_b_dual_st n m).
  Proof.
    intros Prop_3_3 n.
    apply Lemma_3_2_b_work...
    assumption.
  ...
  Lemma Lemma_3_2_c_dual :
    Prop_3_3_st -> forall n m, (Lemma_3_2_c_dual_st n m).
  Proof.
    intros.
...
Lemma Lemma_3_2_b_dual_corr : Prop_3_3_st -> 
                          forall x, forall M P n,
                          is_a_cell (M, P) /\ celldim (M, P) n ->
                          dim x = (S n) /\ minus x ⊆ sub P (S n) ->
                          well_formed ((sub M (S n) ∪ plus x) ∩ √minus x).
Proof with intuition.
  intros Prop_3_3...
  pose (Lemma_3_2_b_dual Prop_3_3 n 1).
...
Qed.
  ...
  Proof with intuition.
    ...
    assert (sub (Setminus (M ∪ plus x) (minus x)) (S m) moves sub M m to sub P m) as FFGG.
      pose (Lemma_3_2_b_dual Prop_3_3 m 1).
      unfold Lemma_3_2_b_dual_st in l.
      assert (is_a_cell
      ...
      + unfold N, Q.
        ...
        * rewrite <- Setminus_is_Intersection_Complement.
          ...
          apply (Lemma_3_2_b_dual_corr Prop_3_3 x (sup M (S m)) (sub M (S m) ∪ sup P m) m)...
