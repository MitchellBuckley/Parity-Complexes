    ...
    assert (Disjoint (Minus S') (Plus (minus x))) as HardDisj.
      ...
      induction p.
        ...
        constructor...
         ...
         assert ((minus x) moves A' to B').
           ...
           assert (is_a_cell ((sup M n) ∪ A', (sup P n) ∪ A')).
             ...
             unfold celldim, setdim, A.
               ...
               assert (dim x1 = n)... rewrite H9...
               rewrite <- S'dim in H6. rewrite <- sub_Plus in H6...
               assert (dim x1 = n)... rewrite H9...
               apply le_trans with (S (dim x1))...
               assert (dim x1 = n)... rewrite H9...
               rewrite <- S'dim in H6. rewrite <- sub_Plus in H6...
           ...
           assert (A' == sub A' (S n)).
             ...
             assert (dim u = S n)...
               unfold In, Z in uinZ...
               unfold S', In in H13... 
               inversion H16; clear H16... apply triangle_rest_in_set in H17... 
           rewrite H5...
         ...
         assert (In Empty_set x0)...
           apply Disjoint_Intersection_condition in H8.
           rewrite <- H8.
           apply In_Intersection...
           unfold S''; exists w...
