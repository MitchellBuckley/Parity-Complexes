...
(*    inversion mltn; clear mltn.
   ...
   assert (Disjoint (sub (mu u) (S (S m))) (sub M (S (S m)) ∩ sub P (S (S m)))) as JJ. 
      ...
      assert (Disjoint P (Minus M))...
        ...
        constructor...
        inversion H. apply (H3 x)... unfold MinusPlus in H2.
        repeat (basic; intuition). inversion H5; exists x0...
      admit.
...
(*     unfold Same_set, Included; repeat (basic; intuition)...  *)
      ...
      + unfold N, Q. 
        ...
        * rewrite <- Setminus_is_Intersection_Complement.
          ...
          constructor. inversion H6; clear H6... apply (H7 x0)...
          apply In_Intersection; repeat (basic; intuition)... 
          exists x... apply well_formed_sup... apply cellcond.
          constructor; repeat (basic; intuition)...
            assert (dim x0 = m)... 
            assert (S (dim x0) <= m)... rewrite <- H13 in H15...
            assert (S (dim x0) = dim x)...
            assert (S (dim x0) <= m)... rewrite H13, dimx in H15...
          constructor; repeat (basic; intuition)...
            inversion H10; clear H10; subst...
            assert (dim x0 = m)... rewrite dimx in H9...
            inversion H10; clear H10; subst...
            assert (S (dim x0) = dim x0)...
            inversion H10; clear H10; subst...
            assert (S (dim x0) <= m)... rewrite dimx in H9...
        * rewrite Union_sym.
          apply Finite_Union...
      ...
      + unfold L, R. 
        ...
        * repeat (rewrite <- Setminus_is_Intersection_Complement).
          ...
          assert (Disjoint M (Plus M))... 
            apply Prop_2_1. apply cellcond. exists P; apply cellcond.
          inversion H9; clear H9. apply (H15 x0)...
          basic... exists x...
      ...
      + unfold N, Q. 
        ...
        * repeat (rewrite <- Setminus_is_Intersection_Complement).
          ...
          constructor; repeat (basic; intuition)...
            ...
            inversion H11; clear H11...
            apply (H17 x0); repeat (basic; intuition). 
            exists y...
        * rewrite <- Setminus_is_Intersection_Complement...
          apply Setminus_Finite'... apply cellcond.
