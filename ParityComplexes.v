...
(* ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ *)
  ...
  Proof with intuition.
    ...
    assert (Disjoint (Minus S') (Plus (minus x))) as HardDisj.
      clear S'2 moves4. inversion plusx2 as [GGG TTT]; clear plusx2. clear S'1 plusx1.
      clear T1 T2. 
      rename mS' into p. rename S'card into J.
      clear Tcard mT.
      clear TFin DisjMT DisjTS'.
      clear TTT DisjUnion Tfinal. 
      clear Bdim movesMtoB movesBtoP.
      clear movesMtoA. 
      revert dependent S'.
      induction p; intros. 
        ...
        constructor...
         apply In_Intersection in H...
         inversion H0 as [w R ]; clear H0...
         inversion H1 as [v R']; clear H1...
         ...
         assert (exists m : carrier, m ∈ Z /\
           ...
           unfold Z; crush.
         inversion H3 as [u [uinZ umax]]; clear H3...
         assert (dim u = S n) as udim.
           unfold Z, In at 1 in uinZ...
         set (S'' := Setminus S' (Singleton u)).
         assert (Disjoint (Minus (S'')) (Plus (minus x))) as KKLL.
           apply IHp; unfold S''.
           (* Finite S *) 
             rewrite Setminus_is_Intersection_Complement. apply Setminus_Finite...
           (* dim S = n+1 *) 
             apply dedede with S'... apply Setminus_Included...
           (* initial segment *) 
             ...
             inversion H4; clear H4. rewrite <- H5 in *. clear y H5.
             apply umax... unfold Z, In at 1... apply triangle_rest_in_set in H3... 
             apply triangle_rest_trans with u... 
             apply uinZ.
             assert (is_a_segment Z S'). 
             unfold Z. 
             apply special_is_segment... 
             apply segment_lemma with S'... 
             unfold Z, In at 1... apply triangle_rest_in_set in H3... 
             apply triangle_rest_trans with u... 
             apply uinZ. 
           (* disjoint from plus x *) 
             apply Disjoint_impl_mor with (x := plus x) (x0 := S')...
             apply Setminus_Included...
           (* dim T = n+1 *) 
             apply dedede with (sub M (S (S n)))...
             rewrite Setminus_Included...
             rewrite Setminus_Included...
             apply sub_idemp.
           (* Included S' M *)
           ...
           (* Bdef holds *) 
             repeat (rewrite <- Setminus_is_Intersection_Complement). 
             fold S''.
             set (B'' := Setminus (sub M (S n) ∪ Plus (S'' ∪ plus x)) (Minus (S'' ∪ plus x))).
             set (T' := Setminus (Setminus (sub M (S (S n))) S'') (plus x)).
             set (A'' := (sub M (S n) ∪ Plus S'') ∩ √Minus S'').
             admit.
           (* dim A = n+1 *) 
             rewrite <- Setminus_is_Intersection_Complement.
             apply dedede with (sub M (S n) ∪ Plus (Setminus S' (Singleton u)))...
             rewrite Setminus_Included...
             rewrite sub_Union. rewrite sub_idemp.
             apply Union_mor... 
             rewrite sub_Plus. rewrite sub_Setminus. 
             apply Plus_Same_set. apply Setminus_Same_set_mor... 
             unfold Same_set, Included... unfold sub, In at 1... 
             inversion H3; clear H3... rewrite <- H4... 
           (* movesAtoB, plus x moves A to B *) admit.
           (* Adef holds with regard to B *) admit.
           (* Cardinality decreases, this is fine *) 
             apply Cardinal_Setminus with (n0 := S p)... 
             unfold Z, In at 1 in uinZ...
           (* A is a cell: plusx2 *) admit.
         ...
         assert ((plus x) moves A' to B').
           ...
           constructor...
             ...
             unfold MinusPlus in H5; apply In_Intersection in H5.
           ...
           constructor...
             ...
             unfold well_formed in H4...
             assert (u = x2)...
               refine (H9 _ _ _ n _ _ _)...
                 apply S'subset. unfold Z, In at 1 in uinZ...
               unfold perp in H4...
               assert (In Empty_set x1)...
                 rewrite <- H11...
               inversion DisjMS'.
               apply (H10 x2)... apply In_Intersection...
               rewrite <- H4.
               unfold Z, In at 1 in uinZ...
         assert (is_a_cell (sup M n ∪ A, sup P n ∪ A)) as HHJJKK. 
           apply (Same_set_is_a_cell _ _ GGG). 
           rewrite Adef, Bdef.
           repeat (rewrite <- Setminus_is_Intersection_Complement).
         ...
         assert ((minus x) moves A' to B').
           ...
           assert (is_a_cell ((sup M n) ∪ A', (sup P n) ∪ A')).
             ...
             apply Cardinality_Singleton_is_one. 
             (* use Adim *) admit.
             unfold Included... inversion H5; clear H5... rewrite <- H6.
             unfold sub, In at 1... unfold Z, In at 1 in uinZ... rewrite <- S'dim in H5.
             assert (dim u = (S n))...
             rewrite PlusMinus_Singleton. 
               rewrite sub_Union. rewrite sub_sup_Empty_set...
               rewrite Empty_set_ident_left...
               admit.
             apply (Same_set_is_a_cell _ _ H5).
             ...
             rewrite Empty_set_ident_left.
             rewrite Empty_set_ident_right. auto.
           apply Prop_3_3 in H5...
           apply (receptive_by_dimension) with (n:= S n) in H6.
           rewrite sub_Union in H6.
           rewrite sub_sup_Empty_set in H6...
           rewrite Empty_set_ident_left in H6.
           assert (A' == sub A' (S n)) as A'dim.
             unfold Same_set, Included...
             unfold sub, In at 1...
             apply eq_S. 
             unfold A' in H5. rewrite <- Adim in H5.
             repeat (basic; intuition)...
         ...
         assert (In Empty_set x0)...
           apply Disjoint_Intersection_condition in KKLL.
           rewrite <- KKLL.
           apply In_Intersection...
           unfold S''; exists w...
