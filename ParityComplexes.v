 ...
 Qed.
  ...
  Proof with intuition.
    ...
    + assert (plus x == Empty_set). admit.
      ...
      unfold receptive_x...
      rewrite H, Minus_Empty_set, Empty_set_zero_right in H4; inversion H4...
      rewrite H1, Plus_Empty_set, Empty_set_zero_right in H4; inversion H4...
    + clear H m.
      apply le_S_n in H0.
      inversion H0; clear H0.
      unfold receptive_x...
...
Qed.
  ...
  Proof with intuition.
    intros n M P cellcond dimcond nsize u udim notatomic.
