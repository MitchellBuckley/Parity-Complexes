  ...
  Admitted.
    ...
    Proof with intuition.
      ...
      assert (is_a_cell (Union (sup M m) A', Union (sup P m) A')) as Q6.
        unfold A'. admit. (*
        set (AM := sup P m ∪ sub A (1+m)).
        set (AP := sup P m ∪ sub A (1+m)).
        assert (is_a_cell (AM, AP)).
          unfold AM, AP.
          apply (Same_set_is_a_cell _ _ D). admit.
          rewrite <- Adim; reflexivity.
        apply Same_set_is_a_cell with (sup AM m ∪ ((sub AM (1+m) ∪ Plus (Singleton u)) ∩ √(Minus (Singleton u)))) (sup AP m ∪ ((sub AM (1+m) ∪ Plus (Singleton u)) ∩ √(Minus (Singleton u)))).
        unfold Lemma_3_2_b_dual_st in Hyp1.
        apply Hyp1...
        apply Cardinality_Singleton_is_one.
        unfold celldim, setdim, AM, AP; intros; repeat (basic; intuition).
...
(*
    assert (Disjoint (Minus S') (Plus (minus x))) as HardDisj.
      assert (S' == Empty_set ∨ Inhabited S')...
        apply Finite_Empty_or_Inhabited.
        apply Cardinal_are_Finite in S'card...
      rewrite H6; constructor...
      apply In_Intersection in H...
      rewrite Minus_Empty_set in H7...
      constructor...
      apply In_Intersection in H...
      inversion H7 as [w R ]; clear H7...
      inversion H8 as [v R']; clear H8...
      unfold S', In at 1 in H...
      inversion H11; clear H11...
      rename x1 into r.
      assert (triangle v r)...
        right with w...
