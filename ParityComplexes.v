...
(* Note that these do not require any new definitions or new concepts *)
    ...
    - assert (Inhabited X).
      ...
      + assert (k <= n).
        ...
        * assert (X == Z).
          ...
          assert (
            exists m : carrier, m ∈ W /\
              (forall y : carrier, y ∈ W -> triangle_rest W y m -> m = y)) as M.
          ...
          (* S k <= n *)
        * assert (
            exists m : carrier, m ∈ Z /\ (forall y : carrier,
    ...
    - assert (Inhabited X).
      ...
      + assert (k <= n).
        ...
        * assert (X == Z).
          ...
          assert (
            exists m : carrier, m ∈ W /\
              (forall y : carrier, y ∈ W -> triangle_rest W m y -> m = y)) as M.
            refine (H k _ _ _ n0 _). rewrite H6; left... unfold W; apply (Cardinal_Setminus carrier_decidable_eq (S (S k)))... rewrite H6...
            unfold W. apply (Included_trans _ X)... unfold Setminus...
            unfold Included, In...
          inversion M as [maxZ K]; clear M...
  ...
  Lemma minimal_exists' : forall (X : Ensemble carrier),
        Finite X /\ Inhabited X ->
          forall n : nat,
          X ⊆ sub Full_set (S n) ->
          exists m : carrier, m ∈ X /\ (forall y : carrier, y ∈ X -> triangle_rest X y m -> m = y).
  Proof with intuition.
    intros X H1.
  ...
  Lemma maximal_exists' : forall (X : Ensemble carrier),
        Finite X /\ Inhabited X ->
          forall n : nat,
          X ⊆ sub Full_set (S n) ->
          exists m : carrier, m ∈ X /\ (forall y : carrier, y ∈ X -> triangle_rest X m y -> m = y).
  Proof with intuition.
    intros X H1.
    assert (exists t, Cardinal X (S t)). apply Finite_Inhabited_Cardinal_Sn...
    inversion H; clear H.
  ...
  Proof with intuition.
    idtac...
        ...
        assert (Finite Z /\ Inhabited Z)...
          ...
          exists x... unfold Z, In at 1... left...
        assert (exists m : carrier, m ∈ Z /\ (forall y : carrier, y ∈ Z -> triangle_rest Z y m -> m = y)).
    ...
    idtac...
        ...
        assert (Finite Z /\ Inhabited Z)...
          ...
          assert ((triangle_rest X x x0) \/ ~(triangle_rest X x x0))...
            apply triangle_rest_dec...
          exists x... unfold Z, In at 1... left...
        assert (exists m : carrier, m ∈ Z /\ (forall y : carrier, y ∈ Z -> triangle_rest Z m y -> m = y)).
  ...
  Proof with intuition.
    ...
    assert (exists m : carrier, m ∈ X /\ (forall y : carrier, y ∈ X -> (triangle_rest X m y) -> m = y)).
      refine (maximal_exists' _ _ (S n) _)...
    ...
    apply H3.
    unfold PlusMinus; apply Intersection_intro...
    exists max...
    apply Complement_intro; intro.
  ...
  Proof with intuition.
    ...
    exfalso. rename H3 into H2.
    unfold Same_set, Included in H2... clear H4.
    assert (exists m : carrier, m ∈ X /\ (forall y : carrier, y ∈ X -> (triangle_rest X y m) -> m = y)).
      refine (minimal_exists' _ _ (S n) _)...
    inversion H2 as [max]; clear H2...
    ...
    assert (In (Empty_set) d).
    apply H3.
    unfold MinusPlus; apply Intersection_intro...
    exists max...
...
(* Now to foramlisations of the content *)
  ...
  Proof with repeat basic; auto.
    ...
    apply Complement_intro... apply (K x x0)...

    unfold Same_set, Included...
    apply Complement_intro... apply (H x x0)...
    pose (axiom1 x).
    assert (In (Plus (plus x) ∪ Minus (minus x)) x0).
    symmetry in s.
    rewrite <- s... apply Union_inv in H0... inversion H0...
...
(* ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ *)
  ...
  (*  This definition repackages receptivity by parametrising it over a value x *)
  ...
  (* A set is receptive when it is receptive_x for all x*)
  ...
  Proof with intuition.
    ...
    inversion H; clear H.
    unfold receptive_x...
    inversion H2... apply Intersection_inv in H3...
      assert (S (S (dim x0)) = dim  x)...
    ...
    + apply H0...
      - unfold Included, sub, In at 2... apply Intersection_inv in H5...
...
(* The receptivity proposition needs only to be checked at dimension 2 and above *)
  ...
  Proof with intuition.
    ...
    apply (transitivity (Nat.le_succ_diag_r _))...
  Qed.
  ...
  Proof with intuition.
    ...
    fold (x ∈ P). rewrite H6. repeat basic.
    left...
    apply Complement_intro. unfold not...
    unfold In, Minus in H7. inversion H7; clear H7... apply minus_dim in H13.
    assert (dim x0 <= n). unfold celldim, setdim in *. apply J...
    rewrite <- H13 in H12. rewrite H11 in H12. apply (Nat.nle_succ_diag_l n)...

    fold (x ∈ M). rewrite H9.
    repeat basic. left... apply Complement_intro. intro.
...
(* ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ *)
  ...
  Proof with intuition.
    ...
    assert (Disjoint M (Plus(minus x))).
      ...
      unfold moves_def in H... unfold Included...
        ...
        apply Intersection_intro... apply Intersection_inv in H... inversion H14.
        rewrite H8... apply Intersection_intro... right... apply Intersection_inv in H...
    ...
    assert (P == P').
      ...
      assert ((Plus (plus x) ∩ √Minus (plus x)) == (Plus (minus x) ∩ Plus (plus x))).
        ...
        apply Complement_intro... assert (In (Empty_set) x0)... rewrite H11. apply Intersection_intro...
      assert ((M ∩ √Minus (plus x)) == (M ∩ √Minus (plus x) ∩ √Plus (minus x))).
        unfold Same_set; unfold Included; repeat (basic; intuition).
          apply Complement_intro... apply (H17 x0)...
      assert ((M ∩ √Minus (minus x)) == (M ∩ √Minus (minus x) ∩ √Plus (plus x))).
        unfold Same_set; unfold Included; repeat (basic; intuition).
        apply Complement_intro... apply (H5 x0). apply Intersection_intro...
      rewrite H, H16, H17.
  ...
  Proof with intuition.
    ...
    assert (Disjoint P (Minus (plus x))).
      ...
      unfold moves_def in H... unfold Included...
        ...
        pose (Prop_1_1 x)...
        rewrite H7... apply Intersection_intro... right... apply Intersection_inv in H...
    ...
    assert (M == M').
      ...
      assert ((P ∩ √Plus (plus x)) == (P ∩ √Plus (plus x) ∩ √Minus (minus x))).
        unfold Same_set; unfold Included; repeat (basic; intuition).
          apply Complement_intro... apply (H5 x0)...
  ...
  Proof with intuition.
    ...
    - unfold Y.
      ...
      + rewrite b.
        ...
        rewrite sub_sub_Empty_set in m0.
        rewrite (sub_sup_cancel) in m0...
        rewrite (sub_sup_cancel) in m0... lia.
      + rewrite b.
        repeat (rewrite sub_idemp || rewrite (sub_sub_Empty_set) ||
                rewrite Empty_set_ident_right ||
                rewrite (sub_sup_Empty_set) ||
  ...
  Proof with intuition.
    ...
    assert (X == (Singleton x) ∪ Z) as XZrel.
      ...
      unfold Same_set, Included... apply Union_inv in H... inversion H0. rewrite <- H...
      intuition.
    ...
    assert (is_a_cell ((sup N n  ∪ Y'), (sup Q n ∪ Y')) /\ Minus Z ∩ sub N (S n) == Empty_set) as AA.
      apply (IHm Z)...
        ...
        assert (PlusMinus Z ⊆ Intersection ((PlusMinus X) ∪ (minus x)) (Complement (plus x))) as JB.
          ...
          assert ((In (minus x) x0) \/ ~(In (minus x) x0))...
            assert (Finite (minus x))... assert (decidable (minus x))...
            apply Complement_intro; intro.
            ...
            assert (In Empty_set x0). rewrite <- H9. apply Intersection_intro... inversion H8. rewrite H8 in H6.
            apply Complement_inv in H6; unfold not in H6...
      ...
      assert (Y == Y') as J3.
        ...
        apply Complement_intro... apply (H2 x0)...
        apply Intersection_intro... apply (Minus_Included Z)...
        rewrite XZrel...
  ...
  Proof with intuition.
    ...
    assert (is_a_cell ((sup N n  ∪ Y'), (sup Q n ∪ Y')) /\ Plus Z ∩ sub Q (S n) == Empty_set) as AA.
      ...
      apply (IHm Z)...
        ...
        assert (MinusPlus Z ⊆ Intersection ((MinusPlus X) ∪ (plus x)) (Complement (minus x))) as JB.
          ...
          assert ((In (plus x) x0) \/ ~(In (plus x) x0))...
            ...
            assert (x = d).
            refine (H7 _ _ _ n _ _ _)... unfold perp in H8...
            assert (In Empty_set x0). rewrite <- H10. apply Intersection_intro... inversion H8. rewrite H8 in H6.
            apply Complement_inv in H6; unfold not in H6...
      ...
      assert (Y == Y') as J3.
        ...
        right; repeat (basic; intuition).
        apply Complement_intro... apply (H2 x0)...
        apply Intersection_intro... apply (Plus_Included Z)...
        rewrite XZrel...
      fold (is_a_cell' (sup N n ∪ Y') (sup Q n ∪ Y')) in AA.
      rewrite J1, J2, <- J3 in AA...
      fold N in LA.
  ...
  (* This is a specific disjointness result proven on page 327. It is not an 
    ...
    Proof with intuition.
      ...
      assert (Disjoint (minus u) (Plus (minus x))).
        ...
        apply Nat.le_trans with (1+ (dim x0))...
  ...
  (* dual 1 *)
    ...
    Proof with intuition.
      ...
      assert (Disjoint (minus u) (Plus (plus x))).
        ...
        apply Nat.le_trans with (1+ (dim x0))...
        assert ((dim x0) = m); simpl in H1... subst. apply Nat.le_refl.
        apply Nat.le_trans with (1+ (dim x0))...
        assert ((dim x0) = m); simpl in H1... subst. apply Nat.le_refl.
        intuition.
        apply receptive_by_dimension  with (n:= 1+m) in H3.
    ...
    Proof with intuition.
      ...
      assert (Disjoint (plus u) (Minus (minus x))) as Q5.
        ...
        assert (receptive (sup M m ∪ A') /\ receptive (sup P m ∪ A')).
          ...
          apply Nat.le_trans with (1+ (dim x0))...
          assert ((dim x0) = m); simpl in H2... subst. apply Nat.le_refl.
          apply Nat.le_trans with (1+ (dim x0))...
  ...
  Proof with intuition.
    ...
    assert (Finite S') as S'Fin.
      ...
      assert (((exists w : carrier, w ∈ plus x /\ triangle_rest (sub M (S (S n))) x0 w)) \/ ~((exists w : carrier, w ∈ plus x /\ triangle_rest (sub M (S (S n))) x0 w)))...
    ...
    assert (Disjoint (plus x) S') as DisjMS'.
      unfold S', Setminus. constructor... apply Intersection_inv in H...
    ...
    assert ((sub M (S (S n))) == S' ∪ (plus x) ∪ T) as DisjUnion.
      unfold Same_set, Included...
        ...
        apply Union_inv in H... apply Union_inv in H0... unfold S', In at 1 in H... inversion H1; clear H1...
    ...
    assert (Disjoint (plus x) T) as DisjMT.
      unfold T, Setminus. constructor... apply Intersection_inv in H...
      unfold In at 1 in H1...
...
(B)) (S n) ∪ Minus (plus x)) ∩ √Plus (plus x)) ∪ (plus x))
    ...
    unfold Same_set, Included...
      exfalso.
      repeat (basic; intuition).
      assert (Inhabited (minus x0))...
        apply minus_Inhabited...
          apply minus_dim in H9...
          rewrite xdim in H9...
          inversion H9... rewrite H11...
        inversion H3; clear H3.
      assert (In (Intersection (Minus (minus x)) (Minus S')) x1); repeat basic; intuition.
        exists x0... exists x0...
      assert (In Empty_set x1)...
        rewrite <- PerpS'minusxB; repeat (basic; intuition)...
      assert (Inhabited (minus x0))...
        apply minus_Inhabited...
          apply minus_dim in H3...
          rewrite xdim in H3...
          inversion H3... rewrite H11...
        inversion H9; clear H9.
      assert (In (Intersection (Minus (minus x)) (Minus T)) x1); repeat basic; intuition.
        exists x0... exists x0...
      assert (In Empty_set x1)...
        rewrite <- PerpTminusxB; repeat (basic; intuition)...
      inversion H3.
  Qed.
  ...
  Proof with intuition.
    ...
    assert (Finite S') as S'Fin.
      ...
      right... unfold S', In at 1 in H0...
      assert (((exists w : carrier, w ∈ minus x /\ triangle_rest (sub P (S (S n))) x0 w)) \/ ~((exists w : carrier, w ∈ minus x /\ triangle_rest (sub P (S (S n))) x0 w)))...
        apply Finite_decidable_existence... apply triangle_rest_dec. apply Finite_sub. apply MPcell.
        left... unfold S', In at 1... right...  apply H2. unfold S', In at 1 in H0...
    assert (sub S' (S (S n)) == S') as S'dim.
      unfold Same_set, Included, sub...
...
(B)) (S n) ∪ Minus (minus x)) ∩ √Plus (minus x)) ∪ (minus x))
    ...
    unfold Same_set, Included...
      ...
      assert (Inhabited (plus x0))...
        apply plus_Inhabited...
          ...
          inversion H9... rewrite H11...
        inversion H3; clear H3.
      assert (In (Intersection (Plus (plus x)) (Plus S')) x1); repeat basic; intuition.
        exists x0... exists x0...
      assert (In Empty_set x1)...
        rewrite <- PerpS'minusxA; repeat (basic; intuition)...
      assert (Inhabited (plus x0))...
        apply plus_Inhabited...
          apply plus_dim in H3;
          rewrite xdim in H3;
          inversion H3... rewrite H11...
        inversion H9; clear H9.
      assert (In (Intersection (Plus (plus x)) (Plus T)) x1); repeat basic; intuition.
        exists x0... exists x0...
      assert (In Empty_set x1)...
        rewrite <- PerpTminusxA; repeat (basic; intuition)...
      inversion H3.
  Qed.

  (* A definition stating that all cells of dimension n are receptive *)
  Definition n_cells_receptive_x : nat -> Prop :=
    fun n => forall M P, is_a_cell (M, P) ->
  ...
  Lemma Prop_3_3_0 : Prop_3_3_st 0.
  Proof with intuition.  
    (* Now to the proof *)
    ...
    + assert (exists d : carrier, sub M 1 == Singleton d).
        apply dim_0_Singleton...
      ...
      - assert (dim x = 2) as xdim.
          ...
          inversion H4...
        inversion H2. apply Intersection_inv in H3; intuition.
  ...
  Lemma Prop_3_3_induction : forall n, (Prop_3_3_st n) 
  ...
  Proof with intuition.
    ...
    + apply receptive_x_restated.
      ...
      - rename b0 into H4. rewrite H4; simpl.
        ...
        * assert (Finite (plus x)) as mXFin...
          ...
          assert (Minus (plus x) ∩ sub M (S (S n)) == Empty_set).
            ...
            rewrite <- JJ...
          inversion H5.
          apply Intersection_inv in H7...
          assert (In (Plus (plus x) ∪ Minus (minus x)) x0).
            rewrite axiom1.
            right...
          apply Union_inv in H7...
          assert (In Empty_set x0)...
          rewrite <- H6; apply Intersection_intro...
          apply H3; exists x0...
      ...
      - assert (sub M (pred (dim x)) == Empty_set).
          ...
          apply Nat.le_trans with (pred (dim x))...
          inversion H2.
        rewrite H2.
    ...
    + apply receptive_x_restated.
      ...
      - rename b0 into H4. rewrite H4; simpl.
        ...
        * assert (Finite (minus x)) as mXFin...
          ...
          apply H3; exists x0...
          assert (In Empty_set x0)...
          rewrite <- H6; apply Intersection_intro...      - assert (sub P (pred (dim x)) == Empty_set).
          unfold celldim, setdim in H1.
          unfold Same_set, Included, sub...
          unfold In at 1 in H2...
          exfalso.
  ...
  Proof with intuition.
    assert (forall n, Prop_3_3_st n) as HH.
    apply Lemma_3_2_and_Prop_3_3.
    intros.
    unfold Prop_3_3_st in HH.
    assert (∃ m : nat, celldim (M, P) m) as K.
    apply cell_has_dim...
    induction K.
    apply HH with x...
  Qed.
...
(* ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ *)
  ...
  Lemma mu'_ind' :
      forall (x : carrier) (P : nat -> Ensemble carrier -> Prop),
        (P (dim x) (Singleton x))
        -> (forall n : nat, n < (dim x)
            -> P (S n) (mu' x (S n)) -> P n (MinusPlus (mu' x (S n))))
          -> (forall n : nat, (dim x) < n -> P n Empty_set)
            -> forall n : nat, P n (mu' x n).
  Proof with intuition.
    intros.
    apply mu'_ind...
  ...
  Proof with intuition.
    ...
    assert (forall j, n <= j ->
      ...
      assert (sub M (S (S j)) == Empty_set) as AA.
        ...
        assert (dim x = S j)...
        rewrite H10 in H7...
        assert (S j <= j)... apply Nat.le_trans with n...
        inversion H7...
      ...
      destruct Q; [exfalso | intuition].
        symmetry in HeqQ. apply leb_complete in HeqQ.
        rewrite CC in HeqQ. assert (S j <= j)... apply Nat.le_trans with n...
      ...
      assert ((sub M 1, sub P 1) === (sub (mu u) 1, sub (pi u) 1)).
        unfold Same_pair...
        assert (exists z : carrier, sub M 1 == Singleton z).
          apply (M_0_Inhabited M P)...
        inversion H7; clear H7.
        ...
        rewrite H8 in H7...
        assert (exists z : carrier, sub P 1 == Singleton z).
          apply (P_0_Inhabited M P)...
        inversion H7; clear H7.
  ...
  Proof with intuition.
    ...
    assert ((sub M (S (S m))) == (sub (mu u) (S (S m))) ∪ ((sub M (S (S m))) ∩ (sub P (S (S m))))) as Mcond.
      ...
      apply (H12 x)... apply Intersection_intro; repeat basic...
    ...
    assert (exists x, (x ∈ X /\ forall r, r ∈ X -> (triangle_rest X r x) -> x = r)) as Xhasmin.
      ...
      exists w... unfold X, In at 1... left... apply Intersection_inv in winMP...
    ...
    assert (exists x, (x ∈ Y /\ forall r, r ∈ Y -> (triangle_rest Y x r) -> x = r)) as Yhasmax.
      ...
      exists w... unfold Y, In at 1... left... apply Intersection_inv in winMP...
      apply (Included_trans _ (sub M (S (S m))))...
    ...
    split.
      apply (Included_trans _ (sub (MinusPlus M) (S m)))...
        ...
        unfold MinusPlus; apply Intersection_intro...
          ...
          apply Complement_intro... inversion H5; clear H5...
    ...
    assert ((x ∈ ((sub M (S (S m))) ∩ (sub P (S (S m))))) \/ (y ∈ ((sub M (S (S m))) ∩ (sub P (S (S m)))))) as xory.
      ...
      assert (In (sub M (S (S m))) x) as OOO. unfold In, X in QQQ. inversion QQQ...
        rewrite Mcond in OOO. apply Union_inv in OOO; inversion OOO...
    ...
    assert (P moves Setminus M (Singleton x) to Setminus P (Singleton x)) as LLKK'.
      apply P_moves_Mx_to_Px; try apply cellcond.
      repeat basic; intuition.
    assert (M moves Setminus M (Singleton x) to Setminus P (Singleton x)) as LLKK.
      apply M_moves_Mx_to_Px; try apply cellcond.
      repeat basic; intuition.
    assert (Setminus M (Singleton x) moves Setminus (M ∪ plus x) (minus x) to P) as HHJJ.
      assert (Singleton x ∪ (M ∩ √Singleton x) == M).
        ...
        apply all_decidable...
        unfold Included... inversion H6; clear H6; subst. apply Intersection_inv in H...
    ...
    assert (sub (Setminus (M ∪ plus x) (minus x)) (S m) moves sub M m to sub P m) as FFGG.
      ...
      + unfold N, Q.
        ...
        * rewrite <- Setminus_is_Intersection_Complement.
          ...
          assert ((dim x0) <= m).
            ...
            apply Nat.le_trans with (S (dim x0))...
          assert ((dim y0) = S m).
      ...
      + unfold L, R.
        ...
        * assert (Inhabited (sub P 1)).
          ...
          exists x0...
          apply Intersection_intro...
          apply Complement_intro... inversion H7; clear H7; subst...
    ...
    assert (sub (Setminus (P ∪ minus y) (plus y)) (S m) moves sub M m to sub P m) as FFGG.
      ...
      + unfold L, R.
        ...
        unfold Included...
          ...
          apply Intersection_inv in H8... idtac...
        rewrite H0, H1...
