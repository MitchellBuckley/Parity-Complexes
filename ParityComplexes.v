...
(* ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ *)
  ...
  Proof with intuition.
    ...
    Proof with intuition.
      ...
      revert T Tcard.
      induction n; intros T Tcard A B M P MPcell Bdim E E0 E1 E2 E3.
      + apply Cardinality_zero_Empty_set in Tcard. 
        rewrite Tcard.
        constructor...
      ...
      + constructor...
        ...
        assert (plus x moves A' to B') as Q1.
          ...
          apply Disjoint_impl_mor with (Plus (plus x)) (minus u); unfold Basics.flip...
          unfold PlusMinus... 
          rewrite Plus_Singleton.
          apply Intersection_Included_cancel_right... 
          rewrite Minus_Singleton...
          ...
          admit. 
          (* *)
          rewrite <- Plus_Singleton. rewrite (Plus_Singleton x). 
      ...
      assert (Disjoint (Plus T') (Minus (minus x))) as Q2.
        ...
        unfold T'.
          ...
          apply uinZ.
        apply Disjoint_impl_mor with T (plus x)...
      assert (Disjoint (minus u) (Minus (minus x))) as Q5.
        admit. (*
