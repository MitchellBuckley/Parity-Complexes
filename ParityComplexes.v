...
(* this is tidying up, it is completely optional, doesn't change the meaning of anything, but might change
  ...
  Admitted.
      ...
      induction p. 
        ...
        constructor...
         ...
         assert ((minus x) moves A' to B').
           ...
           admit. (* this should be fine, doen by dimension?, see paper *)
         assert (Included ((Plus (minus x)) ∩ (minus u)) Empty_set).
           apply (Included_trans _ (A' ∩ (minus u))).
         ...
         assert (S'' moves (sub M (n-1)) to A').
           admit. (* ?? *)
         assert (Disjoint (Minus (S'')) (Plus (minus x))).
           admit. (* ?? *)
         assert (In Empty_set x0)...
           apply Disjoint_Intersection_condition in H16. 
           rewrite <- H16.
           apply In_Intersection...
           unfold S''; exists w...
    ...
    assert ( Plus S' ∩ Plus (minus x) == Empty_set) as PerpS'minusxA.
      unfold Same_set... 
      assert (Plus (minus x) ⊆ Plus (plus x) ∪ Minus (minus x) ). 
        rewrite axiom1...
      unfold Included; intros; exfalso. 
      apply In_Intersection in H6... 
      apply H5 in H8...
      apply In_Union in H8...
      assert (Disjoint (Plus S') (Plus (plus x)))...
        apply (bbbbb (sub M (S (S n))))...
        rewrite Disjoint_sym...
        rewrite DisjUnion...
        apply well_formed_sub... 
        apply MPcell. 
        inversion H8. apply (H9 x0)...
      admit. (* ?? *)
    ...
    assert ( Minus T ∩ Minus (minus x) == Empty_set) as PerpTminusxB.
      ...
      apply In_Union in H5...
      admit. (* ?? *)
      assert (Disjoint (Minus (plus x)) (Minus T))...
       apply (aaaaa (sub M (S (S n))))...
       rewrite DisjUnion... 
        apply well_formed_sub... 
        apply MPcell.
  ...
  Proof with intuition. 
    ...
    assert (sup M 0 == Empty_set) as JA. apply sup_zero... 
    assert (sup P 0 == Empty_set) as JB. apply sup_zero... 
    assert ((sub M 1) ∩ √(Plus X) == Empty_set). 
      unfold Same_set, Included...
    ...
    rewrite JA, I_U_dist_r, H3, Empty_set_ident_left, Empty_set_ident_left...
...
Lemma fffff : forall M P, is_a_cell (M, P) -> 
  ...
  Proof with intuition.
    ...
    rewrite sub_zero...
    rewrite sub_mu.
    refine (mu'_ind' u (fun h => fun  D => Included D (sub M (S h))) _ _ _ k)...
    unfold Included...
      inversion H1; clear H1... subst. 
      unfold sub, In at 1...
    rewrite <- mu'_MinusPlus. (* ?? is my induction principle backwards? *) admit.
  ...
  Lemma notatomic_lemma : 
    ...
    (exists k, k < n /\ ~((sub M (S (S k)), sub P (S (S k))) === (sub (mu u) (S (S k)), 
         sub (pi u) (S (S k))))).
  Admitted.
  ...
  Proof with intuition.
    ...
    assert (forall r, S m < r ->  ((sub M (S r), sub P (S r)) === (sub (mu u) (S r), sub (pi u) (S r)))) as maxprop2.
      intros.
      assert (((sub M (S r), sub P (S r)) ===
             (sub (mu u) (S r), sub (pi u) (S r)))
            ∨ ((sub M (S r), sub P (S r)) ===
               (sub (mu u) (S r), sub (pi u) (S r)) → False))...
        apply Same_pair_dec... 
     apply Finite_sub; apply cellcond.
     apply Finite_sub; apply cellcond.
     rewrite sub_mu; apply mu'_Finite.
   ...
   assert (Disjoint (sub (mu u) (S (S m))) (sub M (S (S m)) ∩ sub P (S (S m)))) as JJ. 
      ...
      rewrite mu'_MinusPlus.
      rewrite <- sub_mu.
      assert ((sub M (S (S (S m))), sub P (S (S (S m)))) ===
  (sub (mu u) (S (S (S m))), sub (pi u) (S (S (S m))))).
      apply (maxprop2 (S (S m)))...
      unfold Same_pair in H...
      rewrite <- H0. 
      (* easy *) 
      admit.
      (* not easy, do we need this extra condition? *)
      admit.
    assert (Disjoint (sub (pi u) (S (S m))) (sub M (S (S m)) ∩ sub P (S (S m)))) as KK'.
      admit.
    ...
    set (Y := fun k => triangle_rest (sub P (S (S m))) w k).
    assert (exists x, (In Y x /\ forall r, In Y r -> (triangle_rest Y x r) -> x = r)) as Yhasmax. 
      refine (maximal_exists' _ _ (S m) _ )... 
      apply (Finite_Included'' (sub P (S (S m)))). apply Finite_sub. apply cellcond.
      ...
      apply (Included_trans _ (sub P (S (S m))))... 
...
Hint Resolve less_irrefl. 
      ...
      apply (Included_trans _ (sub (PlusMinus P) (S m)))...
        unfold Included...
        ...
        unfold In at 1 in H3...
        unfold In at 1...
        apply (Prop_2_1_dual P P)...
      apply cellcond. exists M. apply cellcond. 

    assert (~(x ∈ (sub (mu u) (S (S m)))) \/ ~(y ∈ (sub (pi u) (S (S m))))) as ASD. 
      assert (~((x ∈ (sub (mu u) (S (S m)))) /\ (y ∈ (sub (pi u) (S (S m)))))) as Q.
        unfold not...
    ...
    assert ((x ∈ ((sub M (S (S m))) ∩ (sub P (S (S m))))) \/ (y ∈ ((sub M (S (S m))) ∩ (sub P (S (S m)))))) as xory. 
      inversion ASD as [WER | WER]; clear ASD; [left | right].
        ...
        assert (In (sub P (S (S m))) y) as OOO. unfold In, Y in QQQ. 
        apply triangle_rest_in_set in QQQ... 
        rewrite Pcond in OOO. apply In_Union in OOO; inversion OOO...
    clear ASD.
...
Lemma fffdd : forall x y, less x y -> dim x = dim y. 
Proof with intuition.
  intros.
  unfold less in H...
  inversion H...
    ...
    assert (Singleton x moves M to Setminus (M ∪ plus x) (minus x)) as DDFF.
      unfold moves_def...
        ...
        assert (Disjoint M (Plus M)).
          apply Prop_2_1. apply cellcond. exists P; apply cellcond. 
        constructor... 
        inversion H6; clear H6. 
        apply (H8 x0)... 
        repeat (basic)... 
        exists x... apply all_decidable...
        unfold Included; intros; left... apply H4... 
    assert (Setminus (M ∪ plus x) (minus x) moves M to P) as FFGG. 

pose (Prop_2_4 (Singleton x) (Setminus) )
      unfold moves_def...
...
(*     unfold Same_set, Included; repeat (basic; intuition)...  *)
    ...
    assert (Setminus M (Singleton x) moves Setminus (M ∪ plus x) (minus x) to P) as HHJJ.
      ...
      unfold Same_set, Included; repeat (basic; intuition).
        assert ((In (plus x) x0) \/ ~(In (plus x) x0))...
          apply all_decidable...
        assert ((In (Plus M) x0) \/ ~(In (Plus M) x0))...
          apply all_decidable... apply Plus_Finite... apply cellcond.
        right; inversion H16; exists x1... basic... inversion H10; subst... 
        left; basic... apply H11. exists x...
        assert ((In (plus x) x0) \/ ~(In (plus x) x0))...
          apply all_decidable...
        right... inversion H14; exists x1... basic... inversion H10; subst...
        apply In_Complement...
        apply H11. apply (Minus_Included (Setminus M (Singleton x)) M)... 
        apply Setminus_Included...
        apply In_Complement...
        apply H11. apply (Minus_Included (Setminus M (Singleton x)) M)... 
        apply Setminus_Included...
        right; exists x...
        right; apply (Plus_Included (Setminus M (Singleton x)) M)... apply Setminus_Included...
        apply In_Complement...
        apply H11. inversion H10; exists x1... basic... inversion H16; subst... 
        apply In_Complement...
        apply H11. inversion H10; exists x1... basic... inversion H16; subst... 
        apply In_Complement...
        apply H11. inversion H10; exists x1... basic... inversion H15; subst...
        inversion H14... assert (less x x1). exists x0... assert (x1 = x)... 
          apply H1... unfold X, In at 1... right with x1...
          unfold sub, In at 1... unfold Setminus, In at 1 in H19... 
          assert (dim x = dim x1)... apply fffdd... 
          rewrite H21, dimx...
          right with x1... unfold X, In at 1... right with x1... 
          unfold sub, In at 1... unfold Setminus, In at 1 in H19... 
          assert (dim x = dim x1)... apply fffdd... 
          rewrite H21, dimx...
          left... subst... 
      ...
      rewrite H6 at 1.
      unfold Same_set, Included; repeat (basic; intuition).
        right; inversion H7; exists x1...
        basic... inversion H13; subst...
        assert ((In (Minus M) x0) \/ ~(In (Minus M) x0))...
          apply all_decidable... apply Minus_Finite... apply cellcond.
        right; inversion H15; exists x1...
        basic... inversion H13; subst...
        left. 
        assert (Included (PlusMinus M) P).
          apply Prop_2_1_dual... apply cellcond. exists M; apply cellcond.
        apply H13; unfold PlusMinus; basic... exists x...
        apply In_Complement...
        apply H15. inversion H13; exists x1... unfold Setminus, In at 1 in H17...
        apply In_Complement...
        apply H15. inversion H13; exists x1... unfold Setminus, In at 1 in H17...
        apply In_Complement... inversion H13... 
        assert (x1 = x). assert (well_formed M). apply cellcond.
          unfold well_formed in H15...
          refine (H19 _ _ _ (S m) _ _ _)... basic... admit. admit. 
        unfold perp in H15...
          assert (In Empty_set x0)...
            rewrite <- H20; apply In_Intersection...
        unfold Setminus, In at 1 in H16...
        assert ((In (plus x) x0) \/ ~(In (plus x) x0))...
          apply all_decidable...
        ...
        assert (Disjoint P (Minus M)). 
          apply Prop_2_1_dual. apply cellcond. exists M... apply cellcond. 
        inversion H15... apply (H16 x0)... apply In_Intersection...
        exists x...
        assert ((In (plus x) x0) \/ ~(In (plus x) x0))...
          apply all_decidable...
        left; apply In_Intersection...
        right; inversion H14; exists x1... unfold Setminus, In at 1 in H16...
        apply In_Complement...
        apply H11; inversion H10; exists x1... basic... inversion H16; subst...
        inversion H14... assert (x = x1)... assert (well_formed M). apply cellcond. 
          unfold well_formed in H15... 
          refine (H19 _ _ _ (S m) _ _ _)... 
          basic... admit. admit. unfold perp in H15... assert (In Empty_set x0)...
          rewrite <- H21...
        repeat (basic; intuition)...
    ...
    assert (P moves Setminus M (Singleton x) to Setminus P (Singleton x)) as LLKK'.
      ...
      + unfold N, Q. 
        ...
        * apply well_formed_Union... 
          apply well_formed_Union... 
          apply (well_formed_Included (sub M (S m) ∪ plus x)). 
          apply Disjoint_well_formed... 
          apply well_formed_sub. apply cellcond. admit.
          unfold Included... apply In_Intersection in H6...
          apply well_formed_sup. apply cellcond. assert (S (dim y0) <= m)...
          assert (dim x0 = S m)... admit. 
          rewrite <- H7, H10 in H6...
          inversion H9; clear H9; subst. assert (S (dim x0) <= S m). admit.
          rewrite H7, dimx in H6...
        * rewrite Union_sym.
          apply Finite_Union...
    ...
    - assert (dim y = S m) as ydim. 
      ...
      + unfold N, Q. 
        ...
        * apply well_formed_by_dimension.
          ...
          pose (lt_eq_eq_lt_dec k m)...
            ...
            apply (well_formed_Included P)...
              apply cellcond. 
              apply Setminus_Included.
            apply (well_formed_Included (minus y))...
              apply Setminus_Included.
            rewrite b.
            rewrite <- Plus_Singleton.
            rewrite <- Minus_Singleton.
        ...
        * apply moves_by_dim'. 
          ...
          unfold moves_def...
          assert (P == (M ∪ Plus M) ∩ √Minus M).
            unfold is_a_cell, moves_def in cellcond...
          rewrite H8; clear H8... 
          unfold Same_set, Included; repeat (basic; intuition)...
          assert (M == (P ∪ Minus M) ∩ √Plus M).
            unfold is_a_cell, moves_def in cellcond...
        ...
        * apply moves_by_dim'. 
          ...
          unfold Same_set, Included; repeat (basic; intuition)...
            left; repeat (basic; intuition)...
            apply In_Complement...
            assert ((In (Plus P) x0) \/ ~(In (Plus P) x0))...
            right. inversion H16. exists x1...
            left. repeat (basic; intuition).
            right; exists y... unfold sub, In at 1 in H12...
            apply In_Complement...
            apply In_Complement...
            inversion H15... 
            assert ((x1 = y) \/ ~(x1 = y))...
            ...
            exfalso.
            apply H12. exists x1...
            assert ((In (minus y) x0) \/ ~(In (minus y) x0))...
            left. assert (In (PlusMinus P) x0).
            unfold PlusMinus; basic...
            inversion H15. exists x1... basic...
            apply In_Complement...
            assert (PlusMinus P ⊆ P)...
            apply Prop_2_1_dual... apply cellcond. exists M... apply cellcond...
          unfold Same_set, Included; repeat (basic; intuition)...
            ...
            apply In_Complement... 
            apply In_Complement... 
            right; exists y... unfold sub, In at 1 in H13... 
            inversion H15... basic...
            right; exists x1... apply In_Complement...
            apply In_Complement...
            apply In_Complement...
          repeat (rewrite (sub_Singleton_Empty_set) || 
                  rewrite (Plus_Empty_set) || 
