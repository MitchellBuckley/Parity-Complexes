  ...
  Proof with intuition.
    ...
    assert (is_a_cell ((sup N n  ∪ Y'), (sup Q n ∪ Y')) /\ Minus Z ∩ sub N (S n) == Empty_set) as AA.
      ...
      assert (Y == Y') as J3. 
        ...
        left; repeat (basic; intuition).
        left; repeat (basic; intuition). unfold sub, In at 1 in H5...
        left; repeat (basic; intuition).
        right; repeat (basic; intuition). 
        apply In_Complement... apply (H2 x0). apply In_Intersection...
        apply (Minus_Included Z)... unfold Z... 
        unfold Included... apply In_Intersection in H5...
...
Lemma Same_pair_by_dim' : forall A B C D, (forall k, (sub A (S k), sub B (S k)) === (sub C (S k), sub D (S k))) 
      ...
      assert ({x < n} + {n <= x})...
        assert (((sub M (S (S x)), sub P (S (S x))) ===
            ...
            ∨ ¬((sub M (S (S x)), sub P (S (S x))) ===
                (sub (mu u) (S (S x)), sub (pi u) (S (S x)))))...
        apply Same_pair_dec; apply Finite_sub ; try (apply cellcond). 
          admit. admit.
    ...
    assert ((sub M (S (S m))) == (sub (mu u) (S (S m))) ∪ ((sub M (S (S m))) ∩ (sub P (S (S m))))) as Mcond. 
      ...
      assert (sub (mu u) (S (S m)) == sub (MinusPlus M) (S (S m))).
        rewrite sub_mu.
        assert ({S (S m) <= dim u } + { dim u < S (S m)})...
        ...
        assert (S (m) = n)... 
          ...
          inversion H5; clear H5. 
          rewrite H10 in *.
          assert ({S m < n} + {S m = n} + {n < S m})...
            apply lt_eq_lt_dec... 
          exfalso... exfalso... admit.
      rewrite H5.
      apply sub_Same_set... 
      symmetry. 
      apply Disjoint_result. 
      apply Disjoint_Intersection_condition. 
      assert (Disjoint P (Minus M))... apply all_decidable... apply cellcond.
    ...
    split.
      apply (Included_trans _ (sub (MinusPlus M) (S m)))...
        ...
        unfold sub, In at 1...
        unfold MinusPlus; apply In_Intersection... 
          exists x... unfold X, In at 1 in H... inversion H... apply H5... 
          apply H5...
          apply In_Complement...
        unfold sub, Included...
        unfold In at 1 in H3...
      ...
      apply (Included_trans _ (sub (PlusMinus P) (S m)))...
        ...
        unfold PlusMinus; apply In_Intersection... 
          ...
          apply In_Complement... rewrite AA in H4... 
        unfold sub, Included...
        unfold In at 1 in H3...
        unfold In at 1...
    ...
    assert (~(x ∈ (sub (mu u) (S (S m)))) \/ ~(y ∈ (sub (pi u) (S (S m))))) as ASD. 
      assert (~((x ∈ (sub (mu u) (S (S m)))) /\ (y ∈ (sub (pi u) (S (S m)))))) as Q.
        ...
        assert (is_a_segment (sub (mu u) (S (S m))) (sub M (S (S m)))).
          ...
          apply (fffff M P)... unfold sub, In at 1 in udim...
    ...
    - set (N := (M ∩ (√(Singleton y)))).
      ...
      + split.
        ...
        * unfold L, N...
          repeat (rewrite sub_Union).
          rewrite sub_sup_Empty_set.
          assert ( sub (Singleton y) (S m) == Empty_set) as HH. 
            unfold sub, Same_set, Included, In... 
            exfalso. inversion H9; clear H9. rewrite <- H8, ydim in H10...
          rewrite HH. clear HH.
          rewrite Empty_set_ident_left.
          rewrite Empty_set_ident_right.
          assert (sub ((sub P (S m) ∪ minus y) ∩ √plus y) (S m) == ((sub P (S m) ∪ minus y) ∩ √plus y) ) as BB.
            ...
            inversion H2... 
          rewrite BB.
          set (KK := ((sub P (S m) ∪ minus y) ∩ √plus y)).
          unfold Same_set, Included... 
            ...
            unfold Y, In at 1 in H4. apply triangle_rest_in_set in H4... apply H11. 
            idtac... 
